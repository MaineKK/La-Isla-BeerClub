...
export default function AboutUs() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-[#d1af95]">
      ...
      <div className="relative w-full max-w-5xl mt-18 px-10 py-28 text-center bg-[#b59b83] rounded-xl shadow-lg overflow-hidden">
        ...
        <h1 className="relative text-2xl font-bold text-[#e0bea9] mt-14 z-10">
          Un murciano y dos canarios entran en un bar…
        </h1>
        <p className="relative text-l max-w-4xl mx-auto text-[#d4b9aa] z-10 mt-10 mb-32">
